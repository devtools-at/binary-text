...
<p align="center">
  <a href="https://devtools.at/tools/binary-text"><img src="https://img.shields.io/badge/Try%20Online-DevTools.at-blue?style=for-the-badge" alt="Try Online"></a>
...
<p align="center">
  <b>Convert between binary and text</b>
</p>

<p align="center">
  <a href="https://devtools.at/tools/binary-text">Try Online</a> •
...
**[Try Binary/Text Converter online at DevTools.at →](https://devtools.at/tools/binary-text)**
...
Convert between binary and text. This is a standalone TypeScript/JavaScript implementation that you can use in your own projects.
...
```typescript
import { process } from '@devtools-at/binary-text';
